...
prefix_before <- paste0(precalibration_date,"_before_cleaning/gr071919") 
prefix_after <- paste0(calibration_date,"_after_cleaning/gr072219")
...
# Plot average clean spectra reference
