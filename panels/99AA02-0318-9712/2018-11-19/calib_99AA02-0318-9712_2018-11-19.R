...
# Sphere S/N 402 original reference disk
# 2018-11-19: measurement dirty and clean
...
metadata <- gs_url('https://docs.google.com/spreadsheets/d/1sokEbzwlZYbryDptGexin4EozhLAZRwTk6VJyLrdiGs/edit#gid=0')
...
working_folder <- '2018-11-13-Calibration SPC_99AA02-0318-9712'
...
tar_panel_id <- '99AA02-0318-9712'
tar_calib <- read.table('/Users/etienne/Documents/ProjetsRecherche/CABO/panel-calibrations/panels/99AA02-0318-9712/2018-04-10/SRS-99-010-99AA02-0318-9712-2018-04-10.calib') %>% 
  as_data_frame() %>% 
  rename(wvl = V1, refl = V2)
tar_calib
...
spec_three <- spec_interpol_long %>% 
  ...
  mutate(Calibration = calib,
         Calibration = replace(Calibration, Calibration == 'clean', '2018-11-19 (cleaned)'),
...
spec_all_plot <- ggplot(spec_three, aes(x = wvl, y = refl)) +
  ...
  ylab('Reflectance')
spec_all_plot
ggsave('99AA02-0318-9712_spec_all_plot.png', plot = spec_all_plot, width = 6, height = 3, dpi = 600)
...
drive_upload('99AA02-0318-9712_spec_all_plot.png', path = path_name)
