...
precalibration_date <- "2019-08-09" # this is the date pre-cleaning measurements where made
panel <- "9712"
prefix_wd <- paste0("./panels/", panel_id, "/",calibration_date)

prefix_before <- paste0(precalibration_date,"_before_cleaning/gr080919") ## gr+ date per-cleaning
prefix_after <- paste0(calibration_date,"_after_cleaning/gr081219") ## gr+ date post-cleaning 
