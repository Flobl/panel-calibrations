...
prefix_before <- paste0(precalibration_date,"_before_cleaning/gr091719") ## gr+ date per-cleaning
prefix_after <- paste0(calibration_date,"_after_cleaning/gr091919") ## gr+ date post-cleaning 
